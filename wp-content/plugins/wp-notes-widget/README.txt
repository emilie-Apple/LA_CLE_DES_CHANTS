...
Tags: widget, notes, sidebar, notification, news, events, tweet, twitter, test
...
= 0.3.1 =
* order notes by descending date by default

= 0.3.0 =
* added font style selector
* added option to convert all characters to uppercase
